import DeviceManagement from '@/views/PublicCloud/DeviceManagement.vue' // 导入组件
import Util from '../testUtil'

describe('DeviceManagement.vue', () => {
  let wrapper
  beforeEach(() => {
    wrapper = Util.getRenderedComponent(DeviceManagement) // 每次测试前确保我们的测试实例都是干净完整的。返回一个wrapper对象
    wrapper.setData({
